# Gap status — `mycelium-core`

| Field | Value |
|-------|--------|
| **Component** | `mycelium-core` |
| **Role** | Kernel IR / Value / guarantee lattice |
| **Date** | 2026-07-29 |
...
| **Native twin** | `tzervas/mycelium-core-myc` under [mycelium-lang-myc](https://github.com/tzervas/mycelium-lang-myc) |
| **Local gap notes** | none |
| **Related issues** | Train-wide; pure IR — no host-effect epic local |
